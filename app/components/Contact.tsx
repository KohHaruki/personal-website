    ...
    return (
        <div className="contact section bg-neutral" id="contact">
            <div className="container mx-auto">
                ...
                <p className="text-center">My inbox is always open! Feel free to shoot me an email or connect on LinkedIn.</p>
            </div>

            <div className="socials mt-12 text-content">
                <ul className="flex flex-row justify-center gap-16 text-xl">
